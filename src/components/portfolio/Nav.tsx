export function Nav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 md:px-10 py-6 mix-blend-difference">
      <a href="#" className="font-black tracking-tighter text-2xl text-foreground">
        AXON<span className="text-accent">.</span>
      </a>
